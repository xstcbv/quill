...
class Block extends BlockBlot {
      ...
      softLines.forEach(str => {
        if (i < this.length() - 1 || this.children.tail == null) {
          ...
          if (str === SOFT_BREAK_CHARACTER) {
            super.insertAt(insertIndex, SoftBreak.blotName, SOFT_BREAK_CHARACTER);
          } else {
          ...
          if (str === SOFT_BREAK_CHARACTER) {
            this.children.tail.insertAt(insertIndex, SoftBreak.blotName, SOFT_BREAK_CHARACTER);
          } else {
  ...
  optimize(context) {
    ...
    if (lastLeafInBlock != null && lastLeafInBlock.statics.blotName === SoftBreak.blotName && this.children.tail?.statics.blotName !== Break.blotName) {
